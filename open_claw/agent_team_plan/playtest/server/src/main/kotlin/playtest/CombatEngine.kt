...
object CombatEngine {
    ...
    fun executeKick(
        ...
        val atkBonus = when (attackerOwner.comboTier) {
            1 -> balance.comboT1AtkBonus
            2 -> (balance.comboT1AtkBonus * 1.5).toInt()
            3 -> balance.comboT1AtkBonus * 2
            else -> 0
        }
    ...
    fun processFinalGoal(
        ...
        val multiplier = if (attackerOwner.comboTier == 3) balance.comboT3AtkMultiplier else 1.0
